...
const Table:React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setData(documentRequests? documentRequests: []);
      setIsLoading(false);
            ...
            <div className="flex flex-col">
              ...
              {data.map((datum, key) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-center p-2.5 xl:p-5">
                    <Badge variant={datum.document_status.split(" ")[0] as "secondary" | "default" | "destructive" | "outline" | "active"}>{datum.document_status}</Badge>
                  </div>
                  <div className="flex items-center justify-center p-2.5 xl:p-5">
                  ...
                  <div className="flex items-center justify-center p-2.5 xl:p-5">
                    <p className="text-meta-5">{datum.comments_notes}</p>
                  </div>
                  <div className="flex items-center justify-center p-2.5 xl:p-5">
                    <Popover>
                      <PopoverTrigger>
