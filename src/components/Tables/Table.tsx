      ...
      {isLoading ? (
        ...
        <div className="rounded-lg border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:text-bodydark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <div className="flex flex-col">
            {/* Table headers */}
            <div className="hidden sm:grid grid-cols-7 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-7">
            ...
            {data.map((datum, key) => (
              <div
                className={`grid grid-cols-1 sm:grid-cols-7 gap-4 sm:gap-0 p-4 sm:p-0 ${
